				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 single-blog">
							<a href="#">
								<img class="img-fluid" src="<?php echo base_url();?>assets/user/img/b1.jpg" alt="">
								<ul class="post-tags">
									<li><a href="#">Atribut A</a></li>
									<li><a href="#">Atribut B</a></li>
								</ul>
								<a href="#"><h4>Kopi A</h4></a>
								<p>
									Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore  et dolore.
								</p>
								<a href="#"><p class="post-date">Roastery A</p></a>
							</a>
						</div>
						
						<div class="col-lg-6 col-md-6 single-blog">
							<img class="img-fluid" src="<?php echo base_url();?>assets/user/img/b2.jpg" alt="">
							<ul class="post-tags">
								<li><a href="#">Atribut A</a></li>
								<li><a href="#">Atribut B</a></li>
							</ul>
							<a href="#"><h4>Kopi B</h4></a>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore  et dolore.
							</p>
							<a href="#"><p class="post-date">Roastery B</p></a>
						</div>	
