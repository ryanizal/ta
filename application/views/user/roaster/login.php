            ...
            <!-- <div class="row"> -->
              <div style="display:flex;  align-items: center; justify-content: center;">
                ...
                <div class="col-lg-5 single-menu">
                  ...
                  <a href="<?php echo base_url('Welcome/login'); ?>"><p class="pull-right genric-btn info small circle arrow">Back to Member's Login</p></a>

                  <form method="post" >
                    <div class="form-group">
                      <label class="col-sm-1 ">Username</label>
                      <div class="col-sm-11">
                        <input type="text" name="username_roaster" placeholder="" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" required class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-sm-11">
                      <input type="password" name="password_roaster" placeholder="" onfocus="this.placeholder = ''" onblur="this.placeholder = ''" required class="form-control">
                    </div>
                    <br>
